            ...
            <div className="grid items-center gap-10 md:grid-cols-2">
              <div>
                ...
                <h1 className="mt-3 text-4xl md:text-5xl font-heading font-bold leading-tight text-foreground">
                  Your trusted home with <span className="text-primary">Raye</span> Kam-Kiraye
                </h1>
                <p className="mt-4 text-lg text-muted-foreground max-w-prose">Experience genuine hospitality and welcoming stays at honest, affordable prices. We're here to make you feel right at home.</p>
